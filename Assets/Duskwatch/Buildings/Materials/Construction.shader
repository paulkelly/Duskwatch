...
Shader "Construction"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(Construction)
				UNITY_DEFINE_INSTANCED_PROP(float4, _MainTex_ST)
				UNITY_DEFINE_INSTANCED_PROP(float4, _DisolveGuide_ST)
				UNITY_DEFINE_INSTANCED_PROP(float, _Progress)
			UNITY_INSTANCING_BUFFER_END(Construction)
						 ...
						 ) : SV_Target
			{
				...
				float4 _MainTex_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_MainTex_ST);
				float2 uv_MainTex = input.ase_texcoord9.xy * _MainTex_ST_Instance.xy + _MainTex_ST_Instance.zw;
				
				float _Progress_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_Progress);
				float4 _DisolveGuide_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_DisolveGuide_ST);
				float2 uv_DisolveGuide = input.ase_texcoord9.xy * _DisolveGuide_ST_Instance.xy + _DisolveGuide_ST_Instance.zw;
				...
				float Occlusion = 1;
				float Alpha = ( (-0.6 + ((0.15 + (_Progress_Instance - 0.0) * (1.0 - 0.15) / (1.0 - 0.0)) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + tex2D( _DisolveGuide, uv_DisolveGuide ).r );
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float _Progress_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_Progress);
				float4 _DisolveGuide_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_DisolveGuide_ST);
				float2 uv_DisolveGuide = input.ase_texcoord3.xy * _DisolveGuide_ST_Instance.xy + _DisolveGuide_ST_Instance.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 _MainTex_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_MainTex_ST);
				float2 uv_MainTex = input.ase_texcoord4.xy * _MainTex_ST_Instance.xy + _MainTex_ST_Instance.zw;
				
				float _Progress_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_Progress);
				float4 _DisolveGuide_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_DisolveGuide_ST);
				float2 uv_DisolveGuide = input.ase_texcoord4.xy * _DisolveGuide_ST_Instance.xy + _DisolveGuide_ST_Instance.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 _MainTex_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_MainTex_ST);
				float2 uv_MainTex = input.ase_texcoord2.xy * _MainTex_ST_Instance.xy + _MainTex_ST_Instance.zw;
				
				float _Progress_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_Progress);
				float4 _DisolveGuide_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_DisolveGuide_ST);
				float2 uv_DisolveGuide = input.ase_texcoord2.xy * _DisolveGuide_ST_Instance.xy + _DisolveGuide_ST_Instance.zw;
		...
		Pass
		{
						 ...
						 )
			{
				...
				float _Progress_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_Progress);
				float4 _DisolveGuide_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_DisolveGuide_ST);
				float2 uv_DisolveGuide = input.ase_texcoord5.xy * _DisolveGuide_ST_Instance.xy + _DisolveGuide_ST_Instance.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float _Progress_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_Progress);
				float4 _DisolveGuide_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(Construction,_DisolveGuide_ST);
				float2 uv_DisolveGuide = input.ase_texcoord.xy * _DisolveGuide_ST_Instance.xy + _DisolveGuide_ST_Instance.zw;
				

				surfaceDescription.Alpha = ( (-0.6 + ((0.15 + (_Progress_Instance - 0.0) * (1.0 - 0.15) / (1.0 - 0.0)) - 0.0) * (0.6 - -0.6) / (1.0 - 0.0)) + tex2D( _DisolveGuide, uv_DisolveGuide ).r );
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.RangedFloatNode;15;-2080,288;Inherit;False;InstancedProperty;_Progress;Progress;1;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;43;-1680,224;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0.15;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;36;-1328,448;Inherit;True;Property;_DisolveGuide;Disolve Guide;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.TFHCRemapNode;37;-1296,224;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;-0.6;False;4;FLOAT;0.6;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-352,240;Inherit;False;Constant;_AlphaClipThreshold;AlphaClipThreshold;3;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;38;-1088,208;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;13;-1040,-112;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;12;-784,-112;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
WireConnection;1;7;39;0
ASEEND*/
//CHKSM=5419A1E15E808051727003F4E0062AF5A308E57D